...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Devnoob12/VCPlayerBot)
...
```sh
git clone https://github.com/Devnoob12/VCPlayerBot
cd VCPlayerBot
