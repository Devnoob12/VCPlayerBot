...
async def start(client, message):
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton('🧩 Source', url='https://github.com/Devnoob12/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/Devnoob12/VCPlayerBot'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/team_silent_king'),     
        ],
        [
